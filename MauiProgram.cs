...
namespace ResearchApp
{
    public static class MauiProgram
    {
        ...
        private static void RegisterServices(IServiceCollection services)
        {
            ...
            try
            {
                ...
                //Register SummeriesDatabaseService
                services.AddSingleton<ISummeriesDatabaseService>(provider=>
                new SummeriesDatabaseService(Constants.SummeriesDatabasePath, provider.GetRequiredService< ILogger<SummeriesDatabaseService>>()));
        ...
        private static void RegisterViewModels(IServiceCollection services)
        {
           ...
           /* services.AddSingleton<TestTabbedPage>(provider => new TestTabbedPage(
    ...
    provider.GetRequiredService<ILogger<TestTabbedPage>>()
));*/
            // Register ViewModels
            ...
            new ActiveEmployeesViewModel(
                ...
                provider.GetRequiredService<ILogger<EmployeeWeeklyJobsList>>()
                ));
        }
